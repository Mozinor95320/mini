<div class="container mt-4">
    ...
    <form action="<?php echo URL; ?>tracabilitySheets/updatetracabilitySheet" method="POST">
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading1" class="mb-3">Informations générales</h4>
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading2">Données Fibre</h4>
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading3">Dimensions après enduction</h4>
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading4">Essais de traction avant frettage</h4>
            <div class="row mb-3">
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading5">Essais de traction après frettage</h4>
            <div class="row mb-3">
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading6">Dimension après frettage</h4>
            <div class="row mb-3">
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            ...
            <h4 class="bg-primary px-2" id="scrollspyHeading7">Déclaration de conformité opérateur</h4>
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            ...
            <h4 class="bg-primary px-2" id="scrollspyHeading8">Déclaration de conformité controlleur</h4>
        ...
        <section class="sectionEditTraca px-2 py-2 mb-3">
            <h4 class="bg-primary px-2" id="scrollspyHeading9">Graphique frettage</h4>
            <!-- Chart GENERAL-->
