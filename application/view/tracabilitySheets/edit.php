    ...
    <form action="<?php echo URL; ?>tracabilitySheets/updatetracabilitySheet" method="POST">
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="workOrder" name="workOrder"
                    value="<?php echo htmlspecialchars($tracabilitySheet->workOrder, ENT_QUOTES, 'UTF-8'); ?>" readonly>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="refPlan" name="refPlan"
                    value="<?php echo htmlspecialchars($tracabilitySheet->refPlan, ENT_QUOTES, 'UTF-8'); ?>" readonly>
        ...
        <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" id="aspectDimAfterCoatingOk" name="aspectDimAfterCoatingOk"
                    value="1" <?php if ((bool)$tracabilitySheet->aspectDimAfterCoating === true) echo 'checked'; ?>>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <input type="number" class="form-control" id="force1BeforeShrinkFit" name="force1BeforeShrinkFit"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <input type="number" class="form-control" id="force2BeforeShrinkFit" name="force2BeforeShrinkFit"
                        placeholder="Entrez la force" oninput="calculateMoyenneEcartTypeAvant()"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <input type="number" class="form-control" id="force3BeforeShrinkFit" name="force3BeforeShrinkFit"
                        placeholder="Entrez la force" oninput="calculateMoyenneEcartTypeAvant()"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <input type="number" class="form-control" id="force4BeforeShrinkFit" name="force4BeforeShrinkFit"
                        placeholder="Entrez la force" oninput="calculateMoyenneEcartTypeAvant()"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <input type="number" class="form-control" id="force5BeforeShrinkFit" name="force5BeforeShrinkFit"
                        placeholder="Entrez la force" oninput="calculateMoyenneEcartTypeAvant()"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <input type="number" class="form-control" id="averageBeforeShrinkFit" name="averageBeforeShrinkFit"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <input type="number" class="form-control" id="averageAfterShrinkFit" name="averageAfterShrinkFit"
                        placeholder="Calculée automatiquement" readonly
