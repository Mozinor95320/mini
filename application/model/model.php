...
class Model
{
    ...
    public function updateTracabilitySheet($parameters, $tracabilitySheet_id)
    {
        ...
        operatorDateConformityDeclaration = :operatorDateConformityDeclaration,
        operatorIdConformityDeclaration = :operatorIdConformityDeclaration,
        firstAccumulatorLot = :firstAccumulatorLot,
        controllerConformityDeclaration = :controllerConformityDeclaration,
        controllerDateConformityDeclaration = :controllerDateConformityDeclaration,
        controllerIdConformityDeclaration = :controllerIdConformityDeclaration,
        controllerRemarks = :controllerRemarks,
        status = :status
